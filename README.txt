...
python analyze-md.py --filetype charmm -d example_data -f charmm_300.out charmm_303.out -t 300 303 -b 0 -i 20 -g charmm -e total
...
python analyze-md.py --filetype desmond -d example_data -f Desmond_test_1.ene Desmond_test_2.ene -t 298 298 -b 0 -c 1 1 -i 3 -g desmond -e total

   --------------------------------

Analysis of flat files; just repurposing of earlier gromacs files. (vrescale.argon,prV.argon,prEV.argon)

python analyze-md.py --filetype flatfile -d example_data -f flat.argon.E.down.txt flat.argon.E.up.txt -t 132.915071475571 137.138128524429 -b 0 -i 20 -g flat_E -e total -v > flat_E_output.txt
...
python analyze-md.py --filetype flatfile -d example_data -f flat.argon.EV.down.txt flat.argon.EV.up.txt -t 121.43116059 128.56883941 -p 30 150 -b 0 -i 20 -g flat_EV -e jointEV -v > flat.EV.output.txt
